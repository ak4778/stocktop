...
extern const char *Uniq_nlstab[];
         ...
         * The N_txt_Norm_tab and N_fmt_Norm_tab macros are interchangeable but
         * highlight the two types of strings found in Norm_nlstable.
         */
#define N_col_Head_tab(e) Head_nlstab[e]
#define N_fld_Desc_tab(e) Desc_nlstab[e]
#define N_txt_Norm_tab(e) Norm_nlstab[e]
#define N_fmt_Norm_tab(e) Norm_nlstab[e]
#define N_unq_Uniq_tab(e) Uniq_nlstab[e]
...
enum norm_nls {
   ...
   XTRA_warncfg_txt, XTRA_winsize_txt, BAD_stockid_txt,
#ifndef INSP_OFFDEMO
